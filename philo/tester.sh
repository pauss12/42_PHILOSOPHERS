...
./philo 1 800 200 200 10 | grep dead | cut -d' ' -f2 | sort | uniq -c | run_awk_check '$1 != 1'
...
./philo 4 310 200 100 | grep dead | cut -d' ' -f2 | sort | uniq -c | run_awk_check '$1 != 1'
...
# ./philo 2 500 250 250 | grep dead | cut -d' ' -f2 | sort | uniq -c | run_awk_check '$1 != 1'

echo "${BROWN}Test 11: 2 500 299 201 ${RESET}"
./philo 2 500 299 201 | grep dead | cut -d' ' -f2 | sort | uniq -c | run_awk_check '$1 != 1'

echo "${BROWN}Test 12: 2 500 317 183 ${RESET}"
./philo 2 500 317 183 | grep dead | cut -d' ' -f2 | sort | uniq -c | run_awk_check '$1 != 1'

echo "${BROWN}Test 13: 200 1000 200 200 150 ${RESET}"
./philo 200 1000 200 200 200 | grep eating | cut -d' ' -f2 | sort | uniq -c | run_awk_check '$1 < 150'
